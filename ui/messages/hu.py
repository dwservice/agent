...
data={
    ...
    'alreadyInstalled':u'A DWÜgynök már telepítve van.\n\nAz ügynök automatikusan frissül az utolsó verzióra. Ez azt jelenti, hogy nem kell manuálisan telepítenie az újabb frissítéseket.',
    'back':u'Vissza',
    'cancel':u'Mégse',
    'cancelInstall':u'A telepítés megszakadt.',
    'cancelUninstall':u'Az eltávolítást megszakadt.',
    ...
    'configureChooseMonitorTrayIconVisibility':u'Szeretné megjeleníteni a figyelő ikonját a tálcán ?',
    ...
    'monitorAgentEnabled':u'Ügynök engedelyélyezve.',
    ...
    'pathNotCreate':u'Nem sikerült létrehozni a mappát. Érvénytelen elérési útvonal vagy engedély megtagadva.',
    ...
    'runWithoutInstallationUnexpectedError':u'Váratlan hiba.\nA DWÜgynök nem tudott elindulni. Ha a probléma továbbra is fennáll, kérjük, töltse le a DWÜgynök legújabb kiadását, törölje a \'{0}\' mappát, és futtassa újra a DWÜgynököt.',
