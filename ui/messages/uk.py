...
data={
    ...
    'downloadFile':u'Завантаження файлу {0}...',
    ...
    'runWithoutInstallationUnexpectedError':u'Неочікувана помилка.\nНе вдалося запустити DWAgent. Якщо проблема не зникає, спробуйте завантажити останню версію DWAgent, видаліть папку \'{0}\' і знову запустіть DWAgent.',
