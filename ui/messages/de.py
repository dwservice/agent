...
data={
    ...
    'configureTrayIconOK':u'Sichtbarkeit des Taskleistensymbols eingeschaltet.',
    ...
    'endInstallConfigLater':u'Installation abgeschlossen.\nDer Agent wurde nicht konfiguriert. Die Konfiguration kann immer noch später erfolgen.',
    ...
    'errorAgentNameNotValid':u'Der Agentenname ist ungültig. Zeichen / \ | # @ : . können nicht verwendet werden.',
    ...
    'pathNotCreate':u'Ordner konnte nicht erstellt werden. Ungültiger Pfad oder Erlaubnis verweigert.',
