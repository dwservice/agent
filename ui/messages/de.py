...
data={
    ...
    'welcomeLicense':u'Lizenz:\nDiese Software ist frei und Open Source. Der Hauptbestandteil der Software ist der MPLv2-Lizenz unterstellt, einige zusätzliche Softwarekomponenten sind anderen Lizenzen unterstellt. Für mehr Informationen siehe: https://www.dwservice.net/en/licenses-sources.html',
